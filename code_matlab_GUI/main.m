...
%% test mm3 
% % % % load data
% file_dir = '/Users/Fangwei/Documents/Adder/Analysis/20170519_FS103_DnaN_yPet_glu_25p_200ms_SJW104_2min/analysis_FL_cv2/';
% EXP0 = load([file_dir 'cell_cycle_stat_GUI_all.mat']);
% file_name = [file_dir '20170519_cell_cycle_stat_GUI_all.mat'];
% %         
% % Extract data
...
% % text(-4.5, 12, 'DnaN-yPet','FontSize',30);
% 
% save([file_dir 'mm3_20170518_manual_01.txt'],'EXP0_data','-ascii');

%% test mm3 - mother-daughter
% % load data
file_dir = '/Users/Fangwei/Documents/Adder/Analysis/20170519_FS103_DnaN_yPet_glu_25p_200ms_SJW104_2min/analysis_FL_cv2/';
EXP0 = load([file_dir 'cell_cycle_stat_md_GUI_all.mat']);
file_name = [file_dir '20170519_cell_cycle_stat_md_GUI_all.mat'];
...
save([file_dir 'mm3_20170518_g1_manual_01.txt'],'EXP0_data_g2','-ascii');
save([file_dir 'mm3_20170518_g2_manual_01.txt'],'EXP0_data_g3','-ascii');